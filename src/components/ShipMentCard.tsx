...
export const ShipmentCard = ({
  ...
  <Card
    className={`rounded-xl p-0 border w-full ${
      isActive ? "border-[#5B3CF0]" : "border-gray-200"
    }`}
  >
    <CardContent className="p-4 flex gap-4 md:gap-16 items-start">
      <div className="flex flex-col gap-2 flex-1">
        ...
        <div className="flex gap-2">
          ...
          <div className="flex flex-col text-sm text-gray-600 flex-1 mt-2">
