...
export const OrderTable = ({ orders }: { orders: Order[] }) => (
  <div className="w-full rounded-xl bg-white p-4 shadow">
    ...
    >
      <p className="font-medium text-lg mb-4 text-gray-700">Tracking Order</p>
      <Table className="w-full table-auto text-sm border-separate border-spacing-y-3 whitespace-nowrap">
        ...
        <TableBody>
          {orders.map((o, i) => (
            <TableRow key={i} className="">
              <TableCell className="py-3 text-[#a4a2a8] border-b border-gray-200">
                {o.productId}
              </TableCell>
              <TableCell className="py-3 border-b border-gray-200">
